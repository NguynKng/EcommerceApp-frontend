                ...
                <div className="max-w-[86rem] mx-auto flex flex-col gap-4">
                    ...
                    <div className="relative w-full h-[450px]">
                        ...
                        <div className="absolute inset-0 flex items-center justify-center bg-gray-300">
                            <div className="w-10 h-10 border-4 border-t-orange-500 border-gray-400 rounded-full animate-spin"></div>
                        </div>
                        )}
                        <iframe
                        ...
                        title="Google Map"
                        onLoad={() => setIsLoading(false)} // Hide loading spinner when iframe loads
                        ></iframe>
                    </div>
