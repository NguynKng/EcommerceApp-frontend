      ...
      <div className="pt-6 pb-20 px-2 bg-gray-200">
        <div className="max-w-[70rem] mx-auto flex md:flex-row flex-col gap-10 p-4">
            ...
            <div className="flex flex-col mt-4 overflow-y-auto h-[50rem] scrollbar-hide">
              {user?.cart.items.length === 0 ? (
                <p className="text-gray-500 text-lg">
                  Your cart is empty. Start adding some products to continue.
                </p>
              ) : (
                  ...
                  <div key={index} className="py-6 border-b-2 border-gray-300">
                    <div className="flex gap-6">
                      <Link
                        ...
                        className="min-w-[10.5rem] w-[10.5rem] h-40"
                      >
                        <img
                          src={
                      ...
                      <div className="flex w-full justify-between sm:flex-row flex-col gap-4">
                        <div className="flex flex-col gap-1">
                          ...
                          <span className="text-lg">
                            {formatPriceWithDollar(item.product.price)}
                          </span>
                    ...
                    <div className="flex items-center gap-4 mt-4">
                      <div className="rounded-full flex items-center justify-center border-2 border-gray-300">
                        <div
                          ...
                          onClick={() =>
                            handleRemoveFromCart(item.product._id, user)
                          }
                        >
                        ...
                        <div
                          className="cursor-pointer text-xl py-2 px-4 hover:bg-gray-300 rounded-full"
                          onClick={() => handleAddCart(item.product._id, user)}
                        >
                          +
                        </div>
                      </div>
                      <div
                        className="rounded-full border-2 border-gray-300 p-3 hover:bg-gray-300 cursor-pointer"
                        onClick={(e) => {
          ...
          <div className="md:w-[35%] w-full">
            ...
            <div className="py-6 border-b-2 border-gray-300">
              <div className="flex items-center justify-between">
                ...
                <span className="text-lg font-medium">
                  {formatPriceWithDollar(user?.cart.total)}
                </span>
              </div>
              <div className="flex items-center justify-between">
            ...
            <div className="py-4">
              <Link to="/checkout">
                <button className="text-white text-lg bg-orange-400 w-full rounded-full p-4 hover:opacity-90">
                  Guest Checkout
                </button>
              </Link>
              <Link to="/checkout">
                <button className="text-white text-lg bg-orange-400 mt-4 w-full rounded-full p-4 hover:opacity-90">
                  Member Checkout
                </button>
              </Link>
            </div>
